...
public class CreateIssueSourceRequest {
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The issue source type. This must be \"Board\", \"Project\" or \"Filter\".")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The issue source value. This must be a board ID if the type is \"Board\", a project ID if the type is \"Project\" or a filter ID if the type is \"Filter\".")
