 ...
 */
@ApiModel(description = "The x and y location of the status in the workflow.")
...
public class WorkflowStatusLayout {
   ...
   * @return x
  **/
  @ApiModelProperty(value = "The x axis location.")
  public Double getX() {
    return x;
  }
   ...
   * @return y
  **/
  @ApiModelProperty(value = "The y axis location.")
  public Double getY() {
    return y;
  }
