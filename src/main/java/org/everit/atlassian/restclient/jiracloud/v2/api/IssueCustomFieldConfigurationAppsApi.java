...
import org.everit.atlassian.restclient.jiracloud.v2.model.ConfigurationsListParameters;
import org.everit.atlassian.restclient.jiracloud.v2.model.CustomFieldConfigurations;
import org.everit.atlassian.restclient.jiracloud.v2.model.PageBeanBulkContextualConfiguration;
...
public class IssueCustomFieldConfigurationAppsApi {
  ...
  private static final TypeReference<PageBeanBulkContextualConfiguration> returnType_getCustomFieldsConfigurations = new TypeReference<PageBeanBulkContextualConfiguration>() {};
   ...
   * @param maxResults The maximum number of items to return per page. (optional, default to 100)
   * @param restRequestEnhancer <p>Adds the possibility to modify the rest request before sending out. This can be useful to add authorizations tokens for example.</p>
   * @return Single&lt;PageBeanBulkContextualConfiguration&gt;
   */
  public Single<PageBeanBulkContextualConfiguration> getCustomFieldsConfigurations(
    ConfigurationsListParameters configurationsListParameters, Optional<List<Long>> id, Optional<List<Long>> fieldContextId, Optional<Long> issueId, Optional<String> projectKeyOrId, Optional<String> issueTypeId, Optional<Long> startAt, Optional<Integer> maxResults, Optional<RestRequestEnhancer> restRequestEnhancer) {
    ...
    requestBuilder.requestBody(Optional.of(configurationsListParameters));

    return restClient.callEndpoint(requestBuilder.build(), restRequestEnhancer, returnType_getCustomFieldsConfigurations);
  }
