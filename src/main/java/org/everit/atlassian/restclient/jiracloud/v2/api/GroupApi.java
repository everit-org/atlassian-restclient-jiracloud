...
public class GroupApi {
  ...
  /**
   * Get group
   * <p>This operation is deprecated, use <a href=\"#api-rest-api-2-group-member-get\"><code>group/member</code></a>.</p> <p>Returns all users in a group.</p> <p><strong><a href=\"#permissions\">Permissions</a> required:</strong> <em>Administer Jira</em> <a href=\"https://confluence.atlassian.com/x/x4dKLg\">global permission</a>.</p> 
