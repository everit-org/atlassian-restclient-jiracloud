 ...
 */
@ApiModel(description = "A priority scheme with paginated priorities and projects.")
...
public class PrioritySchemeWithPaginatedPrioritiesAndProjects {
  ...
  **/
  @ApiModelProperty(value = "The ID of the default issue priority.")
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The ID of the priority scheme.")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the priority scheme")
   ...
   * @return priorities
  **/
  @ApiModelProperty(value = "The paginated list of priorities.")
   ...
   * @return projects
  **/
  @ApiModelProperty(value = "The paginated list of projects.")
