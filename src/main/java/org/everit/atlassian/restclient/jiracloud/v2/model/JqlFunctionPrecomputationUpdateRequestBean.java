...
import org.everit.atlassian.restclient.jiracloud.v2.model.JqlFunctionPrecomputationUpdateBean;

/**
 * List of pairs (id and value) for precomputation updates.
 */
@ApiModel(description = "List of pairs (id and value) for precomputation updates.")
...
public class JqlFunctionPrecomputationUpdateRequestBean {
  @JsonProperty("values")
  private List<JqlFunctionPrecomputationUpdateBean> values = new ArrayList<>();
