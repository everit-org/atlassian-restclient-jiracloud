...
public class PermissionsApi {
  ...
  public Single<Permissions> getMyPermissions(
    Optional<String> projectKey, Optional<String> projectId, Optional<String> issueKey, Optional<String> issueId, Optional<String> permissions, Optional<String> projectUuid, Optional<String> projectConfigurationUuid, Optional<String> commentId, Optional<RestRequestEnhancer> restRequestEnhancer) {
    ...
    if (commentId.isPresent()) {
      queryParams.put("commentId", Collections.singleton(String.valueOf(commentId.get())));
    }
    requestBuilder.queryParams(queryParams);
