...
import org.everit.atlassian.restclient.jiracloud.v2.model.StatusUpdate;

/**
 * The list of statuses that will be updated.
 */
@ApiModel(description = "The list of statuses that will be updated.")
...
public class StatusUpdateRequest {
   ...
   * @return statuses
  **/
  @ApiModelProperty(required = true, value = "The list of statuses that will be updated.")
