...
public class IdBean {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The ID of the permission scheme to associate with the project. Use the [Get all permission schemes](#api-rest-api-2-permissionscheme-get) resource to get a list of permission scheme IDs.")
  public Long getId() {
    return id;
  }
