 ...
 */
@ApiModel(description = "The new default issue resolution.")
...
public class SetDefaultResolutionRequest {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The ID of the new default issue resolution. Must be an existing ID or null. Setting this to null erases the default resolution setting.")
  public String getId() {
    return id;
  }
