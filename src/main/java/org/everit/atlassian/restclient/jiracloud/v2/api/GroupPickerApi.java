...
public class GroupPickerApi {
  ...
  public GroupPickerApi(RestClient restClient) {
   ...
   * @param accountId <p>This parameter is deprecated, setting it does not affect the results. To find groups containing a particular user, use <a href=\"#api-rest-api-2-user-groups-get\">Get user groups</a>.</p>  (optional)
