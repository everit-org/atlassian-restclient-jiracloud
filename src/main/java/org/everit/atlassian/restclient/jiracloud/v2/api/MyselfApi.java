...
import org.everit.atlassian.restclient.jiracloud.v2.model.Locale;
...
public class MyselfApi {
  ...
  public MyselfApi(RestClient restClient) {
  ...
  public Single<User> getCurrentUser(
    ...
    return restClient.callEndpoint(requestBuilder.build(), restRequestEnhancer, returnType_getCurrentUser);
  }
  ...
  public Single<Object> setPreference(
    String key, String body, Optional<RestRequestEnhancer> restRequestEnhancer) {
