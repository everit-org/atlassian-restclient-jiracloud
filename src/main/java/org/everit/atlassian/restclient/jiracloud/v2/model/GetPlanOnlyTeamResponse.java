...
public class GetPlanOnlyTeamResponse {
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The plan-only team ID.")
  public Long getId() {
    return id;
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "The planning style for the plan-only team. This is \"Scrum\" or \"Kanban\".")
