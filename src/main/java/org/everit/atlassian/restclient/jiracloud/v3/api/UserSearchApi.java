...
public class UserSearchApi {
  ...
  public Single<List<User>> findAssignableUsers(
    Optional<String> query, Optional<String> sessionId, Optional<String> username, Optional<String> accountId, Optional<String> project, Optional<String> issueKey, Optional<String> issueId, Optional<Integer> startAt, Optional<Integer> maxResults, Optional<Integer> actionDescriptorId, Optional<Boolean> recommend, Optional<RestRequestEnhancer> restRequestEnhancer) {
  ...
  public Single<PageBeanUserKey> findUserKeysByQuery(
    String query, Optional<Long> startAt, Optional<Integer> maxResult, Optional<RestRequestEnhancer> restRequestEnhancer) {
