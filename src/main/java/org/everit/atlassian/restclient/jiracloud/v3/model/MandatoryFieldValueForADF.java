 ...
 */
@ApiModel(description = "An object notation input")
...
public class MandatoryFieldValueForADF {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Will treat as `MandatoryFieldValueForADF` if type is `adf`")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Value for each field. Accepts Atlassian Document Format (ADF) for rich text fields like `description`, `environments`. For ADF format details, refer to: [Atlassian Document Format](https://developer.atlassian.com/cloud/jira/platform/apis/document/structure)")
