...
public class IssueTypePropertyApi {
   ...
   * @param propertyKey <p>The key of the property. Use <a href=\"#api-rest-api-2-issuetype-issueTypeId-properties-get\">Get issue type property keys</a> to get a list of all issue type property keys.</p>  (required)
  ...
  public Single<EntityProperty> getIssueTypeProperty(
    ...
    return RestCallUtil.callEndpoint(httpClient, requestBuilder.build(), restRequestEnhancer, returnType_getIssueTypeProperty);
  }
  ...
  public Single<PropertyKeys> getIssueTypePropertyKeys(
    ...
    return RestCallUtil.callEndpoint(httpClient, requestBuilder.build(), restRequestEnhancer, returnType_getIssueTypePropertyKeys);
  }
  ...
  public Single<Object> setIssueTypeProperty(
    ...
    return RestCallUtil.callEndpoint(httpClient, requestBuilder.build(), restRequestEnhancer, returnType_setIssueTypeProperty);
  }
