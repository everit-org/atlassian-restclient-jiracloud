 ...
 */
@ApiModel(description = "Result of your JQL search. Returns a list of issue IDs and a token to fetch the next page if one exists.")
...
public class IdSearchResults {
   ...
   * @return issueIds
  **/
  @ApiModelProperty(value = "The list of issue IDs found by the search.")
