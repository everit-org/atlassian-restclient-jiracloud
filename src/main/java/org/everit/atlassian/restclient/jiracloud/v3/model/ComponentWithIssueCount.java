...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, isAssigneeTypeValid, realAssigneeType, realAssignee, description, self, projectId, assignee, project, assigneeType, lead, name, id);
  }
