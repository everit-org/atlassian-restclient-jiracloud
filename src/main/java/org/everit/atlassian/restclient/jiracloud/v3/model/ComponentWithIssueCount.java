...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, project, self, description, projectId, assignee, lead, assigneeType, realAssigneeType, realAssignee, isAssigneeTypeValid, name, id);
  }
