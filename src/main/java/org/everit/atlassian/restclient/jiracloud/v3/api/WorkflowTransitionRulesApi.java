...
public class WorkflowTransitionRulesApi {
   ...
   * @param keys The transition rule class keys, as defined in the Connect or the Forge app descriptor, of the transition rules to return. (optional, default to new ArrayList&lt;&gt;())
   * @param workflowNames The list of workflow names to filter by. (optional, default to new ArrayList&lt;&gt;())
   * @param withTags The list of `tags` to filter by. (optional, default to new ArrayList&lt;&gt;())
