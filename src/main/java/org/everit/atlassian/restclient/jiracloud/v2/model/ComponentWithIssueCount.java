...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, description, project, self, projectId, assignee, lead, assigneeType, realAssigneeType, realAssignee, isAssigneeTypeValid, name, id);
  }
