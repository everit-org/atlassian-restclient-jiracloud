 ...
 */
@ApiModel(description = "Details of a notification within a notification scheme.")
...
public class NotificationSchemeNotificationDetails {
  ...
  **/
  @ApiModelProperty(required = true, value = "The notification type, e.g `CurrentAssignee`, `Group`, `EmailAddress`.")
   ...
   * @return parameter
  **/
  @ApiModelProperty(value = "The value corresponding to the specified notification type.")
