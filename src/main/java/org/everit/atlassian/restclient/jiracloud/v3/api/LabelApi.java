...
import org.everit.atlassian.restclient.jiracloud.v3.model.PageBeanString;
...
public class LabelApi {
  ...
  public Single<PageBeanString> getAllLabels(
    ...
    return RestCallUtil.callEndpoint(httpClient, requestBuilder.build(), restRequestEnhancer, returnType_getAllLabels);
  }
