...
public class UpdateProjectDetails {
  ...
  private List<String> releasedProjectKeys = new ArrayList<>();
  ...
  **/
   ...
   * @return categoryId
  **/
  @ApiModelProperty(value = "The ID of the project's category. A complete list of category IDs is found using the [Get all project categories](#api-rest-api-3-projectCategory-get) operation. To remove the project category from the project, set the value to `-1.`")
  ...
  **/
  ...
  public UpdateProjectDetails addReleasedProjectKeysItem(String releasedProjectKeysItem) {
    if (this.releasedProjectKeys == null) {
      this.releasedProjectKeys = new ArrayList<>();
    }
  ...
  **/
  @ApiModelProperty(value = "Previous project keys to be released from the current project. Released keys must belong to the current project and not contain the current project key")
