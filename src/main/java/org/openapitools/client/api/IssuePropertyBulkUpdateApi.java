...
public class IssuePropertyBulkUpdateApi {
  ...
  public Completable bulkDeleteIssueProperty(
    String propertyKey, IssueFilterForBulkPropertyDelete issueFilterForBulkPropertyDelete, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.DELETE;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/issue/properties/{propertyKey}";
    if (propertyKey != null) {
      request.pathParams.put("propertyKey", String.valueOf(propertyKey));
    }
      request.requestBody = Optional.ofNullable(issueFilterForBulkPropertyDelete);
  ...
  public Completable bulkSetIssueProperty(
    String propertyKey, BulkIssuePropertyUpdateRequest bulkIssuePropertyUpdateRequest, Optional<RestRequestInterceptor> restRequestInterceptor) {
    ...
    if (propertyKey != null) {
      ...
      request.requestBody = Optional.ofNullable(bulkIssuePropertyUpdateRequest);
