...
import org.openapitools.client.model.PageBeanFoundFilter;
...
public class FilterApi {
   ...
   * <p>Add a share permissions to a filter. If you add a global share permission (one for all logged-in users or the public) it will overwrite all share permissions for the filter.</p> <p>Be aware that this operation uses different objects for updating share permissions compared to <a href=\"#api-rest-api-3-filter-id-put\">Update filter</a>.</p> <p><strong><a href=\"#permissions\">Permissions</a> required:</strong> <em>Share dashboards and filters</em> <a href=\"https://confluence.atlassian.com/x/x4dKLg\">global permission</a> and the user must own the filter.</p> 
  ...
  public Single<List<SharePermission>> addSharePermission(
    Long id, SharePermissionInputBean sharePermissionInputBean, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.POST;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/{id}/permission";
    if (id != null) {
      request.pathParams.put("id", String.valueOf(id));
    }
      request.requestBody = Optional.ofNullable(sharePermissionInputBean);
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_addSharePermission);
  }

  /**
   * Create filter
   * <p>Creates a filter. The filter is shared according to the <a href=\"#api-rest-api-3-filter-post\">default share scope</a>. The filter is not selected as a favorite.</p> <p><strong><a href=\"#permissions\">Permissions</a> required:</strong> Permission to access Jira.</p> 
  ...
  public Single<Filter> createFilter(
    Filter filter, String expand, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.POST;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter";
    if (expand != null) {
      request.queryParams.put("expand", Collections.singleton(String.valueOf(expand)));
    }
      request.requestBody = Optional.ofNullable(filter);
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_createFilter);
  }
  ...
  public Single<Filter> deleteFavouriteForFilter(
    ...
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/{id}/favourite";
    if (id != null) {
      request.pathParams.put("id", String.valueOf(id));
    }
    if (expand != null) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_deleteFavouriteForFilter);
  }
  ...
  public Completable deleteFilter(
    ...
    request.method = HttpMethod.DELETE;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/{id}";
    if (id != null) {
      request.pathParams.put("id", String.valueOf(id));
    }
  ...
  public Completable deleteSharePermission(
    Long id, Long permissionId, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.DELETE;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/{id}/permission/{permissionId}";
    if (id != null) {
      request.pathParams.put("id", String.valueOf(id));
    }
  ...
  public Single<List<ColumnItem>> getColumns(
    ...
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/{id}/columns";
    if (id != null) {
      request.pathParams.put("id", String.valueOf(id));
    }
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getColumns);
  }
   ...
   */
  public Single<DefaultShareScope> getDefaultShareScope(Optional<RestRequestInterceptor> restRequestInterceptor)
     {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/defaultShareScope";
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_getDefaultShareScope);
  }
  ...
  public Single<List<Filter>> getFavouriteFilters(
    ...
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/favourite";
    if (expand != null) {
      request.queryParams.put("expand", Collections.singleton(String.valueOf(expand)));
    }
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getFavouriteFilters);
  }
  ...
  public Single<List<Filter>> getFilters(
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getFilters);
  }

  /**
   * Search for filters
   * <p>Searches for filters. This operation is similar to <a href=\"#api-rest-api-3-filter-get\">Get filters</a> except that the results can be refined to include filters that have specific attributes. For example, filters with a particular name. When multiple attributes are specified only filters matching all attributes are returned.</p> <p>This operation can be accessed anonymously.</p> <p><strong><a href=\"#permissions\">Permissions</a> required:</strong> None, however, only the following filters that match the query parameters are returned:</p> <ul> <li>filters owned by the user.</li> <li>filters shared with a group that the user is a member of.</li> <li>filters shared with a private project that the user has <em>Browse projects</em> <a href=\"https://confluence.atlassian.com/x/yodKLg\">project permission</a> for.</li> <li>filters shared with a public project.</li> <li>filters shared with the public.</li> </ul> 
  ...
  public Single<PageBeanFoundFilter> getFiltersPaginated(
    String filterName, String accountId, String owner, String groupname, Long projectId, String orderBy, Long startAt, Integer maxResults, String expand, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/search";
    if (filterName != null) {
      request.queryParams.put("filterName", Collections.singleton(String.valueOf(filterName)));
    }
    if (accountId != null) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getFiltersPaginated);
  }
  ...
  public Single<List<Filter>> getMyFilters(
    String expand, Boolean includeFavourites, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/my";
    if (expand != null) {
      request.queryParams.put("expand", Collections.singleton(String.valueOf(expand)));
    }
    if (includeFavourites != null) {
      request.queryParams.put("includeFavourites", Collections.singleton(String.valueOf(includeFavourites)));
    }
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getMyFilters);
  }
  ...
  public Single<SharePermission> getSharePermission(
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getSharePermission);
  }
  ...
  public Single<List<SharePermission>> getSharePermissions(
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getSharePermissions);
  }
  ...
  /**
   * Set columns
   * <p>Sets the columns for a filter. Only navigable fields can be set as columns. Use <a href=\"#api-rest-api-3-field-get\">Get fields</a> to get the list fields in Jira. A navigable field has <code>navigable</code> set to <code>true</code>.</p> <p>The parameters for this resource are expressed as HTML form data. For example, in curl:</p> <p><code>curl -X PUT -d columns=summary -d columns=description https://your-domain.atlassian.net/rest/api/3/filter/10000/columns</code></p> <p><strong><a href=\"#permissions\">Permissions</a> required:</strong> Permission to access Jira, however, columns are only set for:</p> <ul> <li>filters owned by the user.</li> <li>filters shared with a group that the user is a member of.</li> <li>filters shared with a private project that the user has <em>Browse projects</em> <a href=\"https://confluence.atlassian.com/x/yodKLg\">project permission</a> for.</li> <li>filters shared with a public project.</li> <li>filters shared with the public.</li> </ul> 
   * @param id <p>The ID of the filter.</p>  (required)
  ...
  public Single<Object> setColumns(
    Long id, List<String> requestBody, Optional<RestRequestInterceptor> restRequestInterceptor) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_setColumns);
  }
  ...
  public Single<DefaultShareScope> setDefaultShareScope(
    DefaultShareScope defaultShareScope, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.PUT;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/filter/defaultShareScope";
      request.requestBody = Optional.ofNullable(defaultShareScope);
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_setDefaultShareScope);
  }
  ...
  public Single<Filter> setFavouriteForFilter(
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_setFavouriteForFilter);
  }
  ...
  public Single<Filter> updateFilter(
    Long id, Filter filter, String expand, Optional<RestRequestInterceptor> restRequestInterceptor) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_updateFilter);
  }
