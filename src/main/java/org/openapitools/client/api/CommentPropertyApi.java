...
public class CommentPropertyApi {
  ...
  public Completable deleteCommentProperty(
    String commentId, String propertyKey, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.DELETE;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/comment/{commentId}/properties/{propertyKey}";
    if (commentId != null) {
      request.pathParams.put("commentId", String.valueOf(commentId));
    }
    if (propertyKey != null) {
  ...
  public Single<EntityProperty> getCommentProperty(
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getCommentProperty);
  }
  ...
  public Single<PropertyKeys> getCommentPropertyKeys(
    String commentId, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/comment/{commentId}/properties";
    if (commentId != null) {
      request.pathParams.put("commentId", String.valueOf(commentId));
    }
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getCommentPropertyKeys);
  }
  ...
  public Single<Object> setCommentProperty(
    String commentId, String propertyKey, Object body, Optional<RestRequestInterceptor> restRequestInterceptor) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_setCommentProperty);
  }
