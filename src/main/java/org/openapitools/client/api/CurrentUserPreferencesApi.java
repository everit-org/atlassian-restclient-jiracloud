...
public class CurrentUserPreferencesApi {
   ...
   */
  public Single<Object> deleteLocale(Optional<RestRequestInterceptor> restRequestInterceptor)
     {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.DELETE;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/mypreferences/locale";
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_deleteLocale);
  }
   ...
   */
  public Single<Locale> getLocale(Optional<RestRequestInterceptor> restRequestInterceptor)
     {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getLocale);
  }
  ...
  public Single<String> getPreference(
    ...
    request.method = HttpMethod.GET;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/mypreferences";
    if (key != null) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_getPreference);
  }
  ...
  public Single<Object> setLocale(
    Locale locale, Optional<RestRequestInterceptor> restRequestInterceptor) {

    RestRequest request = new RestRequest();
    request.method = HttpMethod.PUT;
    request.basePath = DEFAULT_BASE_PATH;
    request.path = "/rest/api/3/mypreferences/locale";
      request.requestBody = Optional.ofNullable(locale);
    
    if (restRequestInterceptor.isPresent()) {
      restRequestInterceptor.get().enhanceRestRequest(request);
    }

    return RestCallUtil.callEndpoint(httpClient, request, returnType_setLocale);
  }
  ...
  public Single<Object> setPreference(
    String body, String key, Optional<RestRequestInterceptor> restRequestInterceptor) {
    ...
    return RestCallUtil.callEndpoint(httpClient, request, returnType_setPreference);
  }
